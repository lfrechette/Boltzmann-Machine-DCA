...
data = np.loadtxt('data/freq_diff_rang_reg1.txt')
...
plt.savefig('data/freq_diff_1p_rang_reg1.png', dpi=300, bbox_inches='tight')
...
plt.title('Ranganathan code')
plt.savefig('data/freq_diff_2p_rang_reg1.png', dpi=300, bbox_inches='tight')

...
reg0 = np.loadtxt('data/freq_diff_msa_ga.fas_none_1000_0.100000_1000_0.000000.txt')
reg001= np.loadtxt('data/freq_diff_msa_ga.fas_none_1000_0.100000_1000_0.010000.txt')
reg1= np.loadtxt('data/freq_diff_msa_ga.fas_none_1000_0.100000_1000_1.000000.txt')
...
plt.savefig('freq_diff_h_regs.png', dpi=300, bbox_inches='tight')
...
for j in range(3):
    ...
    ax[j].set_title(r'$\lambda=%.02f$' % regs[j])
    ax[j].set_xlim([0,1000])
plt.savefig('freq_diff_J_regs.png', dpi=300, bbox_inches='tight')
'''
for j in range(3):
    data = mylist[j]
    ax[j].plot(data[:,0],data[:,1])
